      ...
      <div style={styles.container}>
        <div className={styles.pricing_top}>
          <Container >
            ...
            <h2>Your Hubspot settings are being saved...</h2>
            {/* <p>Engage like an expert should. Upgrade each customer touchpoint into a conversation.</p> */}

            {!showWait && 
            (<><br></br><b>Done! You may now close this tab.</b></>)
            }

            {showError && 
            (<><br></br><b>Ooops! We encountered an error. Support has been notified and will be in touch with you shortly.</b></>)
            }
