            ...
            <div className={styles.Ratingbandsdetails}>
                <div className={styles.settingheaderbox}>
                    ...
                    {/* <div className={styles.flexrightbutton}>
                        {manageoption ? <a href="/" className={styles.btn_skyblue} onClick={()=>{setManageoption(false)}}>Back Option</a>
                        :
                        <a href="/" className={styles.btn_skyblue} onClick={()=>{setManageoption(true)}}>Manage Option Settings</a>
                        }
                    </div> */}
                </div>
